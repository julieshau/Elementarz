...
public class LettersLevel2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonClose.setOnClickListener(v -> {
            try {
                Intent intent = new Intent(LettersLevel2.this, LettersGameLevels.class);
        ...
        buttonContinueEnd.setOnClickListener(v -> {
            try {
                Intent intent = new Intent(LettersLevel2.this, LettersLevel3.class);
                startActivity(intent);
                finish();
            }catch (Exception e){
        ...
        //animation
        Animation a = AnimationUtils.loadAnimation(LettersLevel2.this, R.anim.alpha);
